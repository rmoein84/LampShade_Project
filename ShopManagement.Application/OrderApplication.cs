...
public class OrderApplication : IOrderApplication
{
    ...
    public OrderApplication(IOrderRepository orderRepository, IAuthHelper authHelper, IShopInventoryAcl shopInventoryAcl, ISmsService smsService, IShopAccountAcl shopAccountAcl, IConfiguration configuration)
    {
